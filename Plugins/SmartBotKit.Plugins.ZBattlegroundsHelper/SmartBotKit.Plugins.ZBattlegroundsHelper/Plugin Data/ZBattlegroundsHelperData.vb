...
#Region " ZBattlegroundsHelperData "
...
Namespace PluginTemplate
    ...
    ''' ----------------------------------------------------------------------------------------------------
    ''' <summary>
    ''' Plugin data for <see cref="ZBattlegroundsHelper"/> plugin class.
    ''' </summary>
    ''' ----------------------------------------------------------------------------------------------------
    ...
    <Serializable>
    <DebuggerNonUserCode>
    Public NotInheritable Class ZBattlegroundsHelperData : Inherits PluginDataContainer
...
#Region " Settings "
        ...
        <Browsable(True)>
        <ItemsSource(GetType(ZBattlegroundsHelperDataSource))>
...
#Region " Constructors "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        ''' <summary>
        ''' Initializes a new instance of the <see cref="ZBattlegroundsHelperData"/> class.
        ''' </summary>
        ''' ----------------------------------------------------------------------------------------------------
        Public Sub New()
            MyBase.Name = Me.Name
